...
12. **Intent taxonomy: clustering discovered, domain knowledge reconciled.** Embedding clusters name candidate intents; a seeded domain list (login, billing, playback, premium…) acts as a sanity checklist (see `docs/intent-seed-taxonomy.md`). Neither alone is defensible.
